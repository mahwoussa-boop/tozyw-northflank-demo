...
"""
# ⚰️ RETIRED-KEEP (2026-07-22 — توثيق آلي يتبع نمط قرار المالك 2026-07-10، لا حذف):
# مستوردها الوحيد في المستودع كله هو engines/async_scraper.py (تحقُّق grep 2026-07-22) —
# وهو نفسه مسار كشط قديم صفر مستوردين إنتاجياً (المسار الحيّ عبر services/scraper_service،
# انظر RESERVED-KEEP على async_scraper.py:945). خامل بالتبعية لا بذاته. لا يُحذف بلا مراجعة مالك صريحة.
# التراجع = حذف هذا التعليق فقط.
